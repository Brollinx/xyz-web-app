...
const DevDebugOverlay: React.FC<DevDebugOverlayProps> = ({
  ...
  return (
    <Card className="absolute bottom-4 right-4 w-80 bg-yellow-100/90 backdrop-blur-sm shadow-lg z-50 text-xs">
      ...
      <CardContent className="p-2 pt-1 space-y-1">
        ...
        {lastDirectionsResponseSummary && (
          <div>
            ...
            <pre className="bg-gray-50 p-1 rounded overflow-auto max-h-20">{JSON.stringify(lastDirectionsResponseSummary, null, 2)}</pre>
          </div>
        )}
        {routeError && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-2 py-1 rounded relative mt-2">
