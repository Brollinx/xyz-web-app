...
interface StoreDetailsMobileBottomSheetProps {
  store: StoreInfo;
...
const StoreDetailsMobileBottomSheet: React.FC<StoreDetailsMobileBottomSheetProps> = ({
  store,
  userLocation,
  routeGeoJson,
  mapStyle,
...
export default StoreDetailsMobileBottomSheet;